...
const createWallet = async () => {
  try {
    ...
    const centralWalletBalance = await provider.getBalance(centralWallet.address);
    console.log(`Central wallet balance: ${ethers.formatEther(centralWalletBalance)} ETH`);
    ...
    console.log(`Creating transaction to send ${ethers.formatEther(amountToSend)} ETH to new wallet...`);
    const tx = {
