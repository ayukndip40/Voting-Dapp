...
const addCandidate = async (req, res) => {
  ...
  try {
    ...
    const nextCandidateId = await electionContract.nextCandidateIdByElection(
      electionId
    );
    ...
    res.json({ message: "Candidate added successfully", candidateId });
  } catch (error) {
...
const updateCandidate = async (req, res) => {
  ...
  try {
    ...
    const tx = await electionContract.updateCandidate(
      electionId,
      candidateId,
      name
    );
...
const deleteCandidate = async (req, res) => {
  ...
  try {
    ...
    const tx = await electionContract.deleteCandidate(
...
const getCandidates = async (req, res) => {
  ...
  try {
    ...
    const totalElections = electionCount.toNumber
      ? electionCount.toNumber()
      : parseInt(electionCount);
