...
const ElectionList = ({ onSelectElection }) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-[calc(100vh-120px)] bg-gray-100 py-4">
      {" "}
      {/* Added py-4 for vertical space */}
      <div className="bg-white shadow-md rounded-lg w-full max-w-4xl p-8 h-auto laptop:max-w-[1024px] laptop:min-h-[700px]">
        ...
        <div className="mt-6 flex justify-center space-x-2">
          {Array.from({
            length: Math.ceil(filteredElections.length / PAGE_SIZE),
          }).map((_, index) => (
            <button
              key={index}
